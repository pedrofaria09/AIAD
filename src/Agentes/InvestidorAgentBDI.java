...
public class InvestidorAgentBDI implements IFollowService {
	...
	/*Recebe um objecto Following que cont�m:
	...
	*/
	public void checkToFollow(Following f) {	
		//Para n�o comunicar com ele pr�prio
	...
	//Agente � informado por quem est� a seguir de uma a��o para comprar
	private boolean buyThisAction(String nomeAgente, Acao acao) {
		if(!checkIfDontHaveAction(acao.getNomeBolsa())) {
			String text = "";
			text += "O agente " +nomeAgente+ " disse para comprar a acao "+ acao.getNomeBolsa() +", mas j� a tenho.\n";
			frame.jTextArea1.append(text);
			return false;
		}		
		...
		if(this.cash > acao.getValorDeCompra()) {
			...
			String text = "";
			text += "Vou comprar a a��o que o " +nomeAgente+ " comprou:\n";
			...
			String text = "";
			text += "Ia a a��o "+acao.getNomeBolsa() + " que o " +nomeAgente+ " comprou, mas n�o tenho dinheiro.\n";
			frame.jTextArea1.append(text);
			return false;
		}
	}
